...
public class ObjectPoolerBrokenCubes : MonoBehaviour
{
     #region Singleton
    public static ObjectPoolerBrokenCubes Instance;
    private void Awake()
    {
        Instance = this;
    }
    ...
    void Start()
    {
        ...
        inactiveParent.transform.name = "InactiveBrokenCubes";
    }
    ...
    public void SetObjects()
    {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                obj.name = "BrokenCube" + i.ToString();
                obj.SetActive(false);
                inactiveObjects.Add(obj);
